...
public class BoardTiles {
	...
	public void init() {
		...
		Baltic_Avenue.setRentH1(1);
		Baltic_Avenue.setRentH2(1);
		Baltic_Avenue.setRentH3(1);
		Baltic_Avenue.setRentH4(1);
		Baltic_Avenue.setRentH5(1);
		Baltic_Avenue.setHouseCost(1);
		Baltic_Avenue.setMortgage(1);
		//3 Oriental_Avenue
		
		Oriental_Avenue.setName("Oriental Avenue");
		Oriental_Avenue.setColor(PropertyType.darkBlue);
		Oriental_Avenue.setPrice(1);
		Oriental_Avenue.setHouse(0);
		Oriental_Avenue.setRent(1);
		Oriental_Avenue.setRentH1(1);
		Oriental_Avenue.setRentH2(1);
		Oriental_Avenue.setRentH3(1);
		Oriental_Avenue.setRentH4(1);
		Oriental_Avenue.setRentH5(1);
		Oriental_Avenue.setHouseCost(1);
		Oriental_Avenue.setMortgage(1);
		//4 Vermont_Avenue
		
		Vermont_Avenue.setName("Vermont Avenue");
		Vermont_Avenue.setColor(PropertyType.darkBlue);
		Vermont_Avenue.setPrice(1);
		Vermont_Avenue.setHouse(0);
		Vermont_Avenue.setRent(1);
		Vermont_Avenue.setRentH1(1);
		Vermont_Avenue.setRentH2(1);
		Vermont_Avenue.setRentH3(1);
		Vermont_Avenue.setRentH4(1);
		Vermont_Avenue.setRentH5(1);
		Vermont_Avenue.setHouseCost(1);
		Vermont_Avenue.setMortgage(1);
		
		//5 Connecticut_Avenue
		
		Connecticut_Avenue.setName("Connecticut Avenue");
		Connecticut_Avenue.setColor(PropertyType.darkBlue);
		Connecticut_Avenue.setPrice(1);
		Connecticut_Avenue.setHouse(0);
		Connecticut_Avenue.setRent(1);
		Connecticut_Avenue.setRentH1(1);
		Connecticut_Avenue.setRentH2(1);
		Connecticut_Avenue.setRentH3(1);
		Connecticut_Avenue.setRentH4(1);
		Connecticut_Avenue.setRentH5(1);
		Connecticut_Avenue.setHouseCost(1);
		Connecticut_Avenue.setMortgage(1);
		//6 StCharles_Place
	
		StCharles_Place.setName("St. Charles Place");
		StCharles_Place.setColor(PropertyType.darkBlue);
		StCharles_Place.setPrice(1);
		StCharles_Place.setHouse(0);
		StCharles_Place.setRent(1);
		StCharles_Place.setRentH1(1);
		StCharles_Place.setRentH2(1);
		StCharles_Place.setRentH3(1);
		StCharles_Place.setRentH4(1);
		StCharles_Place.setRentH5(1);
		StCharles_Place.setHouseCost(1);
		StCharles_Place.setMortgage(1);
		//7 States_Avenue
		
		States_Avenue.setName("States Avenue");
		States_Avenue.setColor(PropertyType.darkBlue);
		States_Avenue.setPrice(1);
		States_Avenue.setHouse(0);
		States_Avenue.setRent(1);
		States_Avenue.setRentH1(1);
		States_Avenue.setRentH2(1);
		States_Avenue.setRentH3(1);
		States_Avenue.setRentH4(1);
		States_Avenue.setRentH5(1);
		States_Avenue.setHouseCost(1);
		States_Avenue.setMortgage(1);
		//8 Virginia_Avenue
		
		Virginia_Avenue.setName("Virginia Avenue");
		Virginia_Avenue.setColor(PropertyType.darkBlue);
		Virginia_Avenue.setPrice(1);
		Virginia_Avenue.setHouse(0);
		Virginia_Avenue.setRent(1);
		Virginia_Avenue.setRentH1(1);
		Virginia_Avenue.setRentH2(1);
		Virginia_Avenue.setRentH3(1);
		Virginia_Avenue.setRentH4(1);
		Virginia_Avenue.setRentH5(1);
		Virginia_Avenue.setHouseCost(1);
		Virginia_Avenue.setMortgage(1);
		//9 StJames_Place
		
		StJames_Place.setName("St. James Place");
		StJames_Place.setColor(PropertyType.darkBlue);
		StJames_Place.setPrice(1);
		StJames_Place.setHouse(0);
		StJames_Place.setRent(1);
		StJames_Place.setRentH1(1);
		StJames_Place.setRentH2(1);
		StJames_Place.setRentH3(1);
		StJames_Place.setRentH4(1);
		StJames_Place.setRentH5(1);
		StJames_Place.setHouseCost(1);
		StJames_Place.setMortgage(1);
		//10 Tennessee_Avenue
	
		Tennessee_Avenue.setName("Tennessee Avenue");
		Tennessee_Avenue.setColor(PropertyType.darkBlue);
		Tennessee_Avenue.setPrice(1);
		Tennessee_Avenue.setHouse(0);
		Tennessee_Avenue.setRent(1);
		Tennessee_Avenue.setRentH1(1);
		Tennessee_Avenue.setRentH2(1);
		Tennessee_Avenue.setRentH3(1);
		Tennessee_Avenue.setRentH4(1);
		Tennessee_Avenue.setRentH5(1);
		Tennessee_Avenue.setHouseCost(1);
		Tennessee_Avenue.setMortgage(1);
		//11 New_York_Avenue
	
		New_York_Avenue.setName("New York Avenue");
		New_York_Avenue.setColor(PropertyType.darkBlue);
		New_York_Avenue.setPrice(1);
		New_York_Avenue.setHouse(0);
		New_York_Avenue.setRent(1);
		New_York_Avenue.setRentH1(1);
		New_York_Avenue.setRentH2(1);
		New_York_Avenue.setRentH3(1);
		New_York_Avenue.setRentH4(1);
		New_York_Avenue.setRentH5(1);
		New_York_Avenue.setHouseCost(1);
		New_York_Avenue.setMortgage(1);
		//12 Kentucky_Avenue
		
		Kentucky_Avenue.setName("Kentucky Avenue");
		Kentucky_Avenue.setColor(PropertyType.darkBlue);
		Kentucky_Avenue.setPrice(1);
		Kentucky_Avenue.setHouse(0);
		Kentucky_Avenue.setRent(1);
		Kentucky_Avenue.setRentH1(1);
		Kentucky_Avenue.setRentH2(1);
		Kentucky_Avenue.setRentH3(1);
		Kentucky_Avenue.setRentH4(1);
		Kentucky_Avenue.setRentH5(1);
		Kentucky_Avenue.setHouseCost(1);
		Kentucky_Avenue.setMortgage(1);
		//13 Indiana_Avenue
		
		Indiana_Avenue.setName("Indiana Avenue");
		Indiana_Avenue.setColor(PropertyType.darkBlue);
		Indiana_Avenue.setPrice(1);
		Indiana_Avenue.setHouse(0);
		Indiana_Avenue.setRent(1);
		Indiana_Avenue.setRentH1(1);
		Indiana_Avenue.setRentH2(1);
		Indiana_Avenue.setRentH3(1);
		Indiana_Avenue.setRentH4(1);
		Indiana_Avenue.setRentH5(1);
		Indiana_Avenue.setHouseCost(1);
		Indiana_Avenue.setMortgage(1);
		...
		Ventor_Avenue.setColor(PropertyType.darkBlue);
		Ventor_Avenue.setPrice(1);
		Ventor_Avenue.setHouse(0);
		Ventor_Avenue.setRent(1);
		Ventor_Avenue.setRentH1(1);
		Ventor_Avenue.setRentH2(1);
		Ventor_Avenue.setRentH3(1);
		Ventor_Avenue.setRentH4(1);
		Ventor_Avenue.setRentH5(1);
		Ventor_Avenue.setHouseCost(1);
		Ventor_Avenue.setMortgage(1);
		//17 Marvin_Gardens
	
		Marvin_Gardens.setName("Marvin Gardens");
		Marvin_Gardens.setColor(PropertyType.darkBlue);
		Marvin_Gardens.setPrice(1);
		Marvin_Gardens.setHouse(0);
		Marvin_Gardens.setRent(1);
		Marvin_Gardens.setRentH1(1);
		Marvin_Gardens.setRentH2(1);
		Marvin_Gardens.setRentH3(1);
		Marvin_Gardens.setRentH4(1);
		Marvin_Gardens.setRentH5(1);
		Marvin_Gardens.setHouseCost(1);
		Marvin_Gardens.setMortgage(1);
		//18 Pacific_Avenue
		
		Pacific_Avenue.setName("Pacific Avenue");
		Pacific_Avenue.setColor(PropertyType.darkBlue);
		Pacific_Avenue.setPrice(1);
		Pacific_Avenue.setHouse(0);
		Pacific_Avenue.setRent(1);
		Pacific_Avenue.setRentH1(1);
		Pacific_Avenue.setRentH2(1);
		Pacific_Avenue.setRentH3(1);
		Pacific_Avenue.setRentH4(1);
		Pacific_Avenue.setRentH5(1);
		Pacific_Avenue.setHouseCost(1);
		Pacific_Avenue.setMortgage(1);
